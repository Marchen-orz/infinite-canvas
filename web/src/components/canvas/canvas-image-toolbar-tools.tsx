...
export type ImageQuickToolId = "info" | "delete" | "saveAsset" | "download" | "regenerate" | ImageNodeActionToolId;
...
const defaultBaseToolIds: ImageQuickToolId[] = ["info", "delete", "saveAsset", "download", "regenerate"];
