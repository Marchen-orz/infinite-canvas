export default {
    ...
    settingsPanels: {
        ...
        image: { title: "Image settings", quality: "Quality", size: "Size", align16: "Align to multiples of 16", align16Hint: "Round dimensions up to the next multiple of 16 after input", aspectRatio: "Aspect ratio", transparent: "Transparent background", transparentHint: "Generate an image without a background when supported by the model", count: "Image count", images: "{{count}} images", comfyui: "ComfyUI workflow", negativePrompt: "Negative prompt", denoise: "Reference strength (Denoise)", denoiseHint: "Lower values retain more of the reference image; higher values allow more variation.", upscale: "Upscale", upscaleFactor: "Upscale factor" },
        video: { title: "Video settings", quality: "Quality", size: "Size", seconds: "Seconds", resolution: "Resolution", ratio: "Aspect ratio", duration: "Duration", smart: "Smart", output: "Output", generateAudio: "Generate audio", watermark: "Add watermark", contextIr: "Context-IR optimization", skillId: "Skill ID (optional)", adaptive: "Adaptive", sizes: { landscape: "Landscape", portrait: "Portrait", square: "Square", widescreen: "Widescreen", tall: "Tall", auto: "Auto" }, ratios: { landscape: "Landscape", portrait: "Portrait", square: "Square", standardLandscape: "Standard landscape", standardPortrait: "Standard portrait", cinematic: "Cinematic", adaptive: "Adaptive" } },
    ...
    config: {
        ...
        modelSelect: {
            ...
            modelName: "Enter a model ID",
            add: "Add model",
            fetch: "Fetch model list",
            description: "If the provider does not expose an OpenAI /models endpoint, add model IDs manually here, then set display names in the provider models.",
        ...
        webdav: {
            title: "WebDAV sync",
            description: "Sync all persistent app data: canvases, assets, generation history, local media, AI configuration (including API keys), UI settings, prompt sources, node plugins, plugin-private data, and the prompt cache. The current WebDAV connection and runtime sessions are excluded. The browser connects directly to WebDAV.",
            lastSynced: "Last synced {{time}}",
            neverSynced: "Not synced yet",
            url: "WebDAV URL",
            directory: "Remote directory",
            directoryDescription: "Business directories are created here. Each contains {{manifest}}, with media stored under files/ when present",
            username: "Username",
